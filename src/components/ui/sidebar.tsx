...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7 shadow-md rounded-lg", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
    ...
    >
      <ChevronLeft 
        className={cn(
          "text-secondary transition-transform duration-200 ease-in-out",
          open ? "" : "rotate-180"
        )} 
      />
