...
export default function Hero() {
  return(
    <header className="relative w-full lg:h-[532px] md:h-[350px] relative">
      ...
      <div className="relative flex flex-col items-start justify-center w-full h-full lg:px-20 xl:px-30 md:px-10  gap-10">
        <div className="relative">
          <h1 className="lg:text-4xl md:text-2xl font-semibold text-foreground lg:max-w-[749px] md:max-w-[500px] lg:leading-[54px] md:leading-[38px]">
            <span className="text-primary">
              Hidup Nyaman & Berkah&nbsp;
            </span>
            dengan Properti Syariah Kelas Dunia
          </h1>
          <Image src={HeroIcon} alt="Hero icon panglima propertindo" className="absolute lg:top-15 lg:left-85 md:top-10 md:left-58 md:w-[100px] lg:w-[144px]" />
        </div>
        <p className="lg:max-w-[749px] md:max-w-[500px] lg:text-xl md:text-base sm:text-sm text-secondary-foreground">
